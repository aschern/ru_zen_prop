...
class Articles_annotations(object):
    ...
    def __init__(self, spans=None, article_id:str=None):
    ...
    def _matching_annotations(self, second_annotations, i:int):
    ...
    def adapt_annotation_to_new_text(self, original_text:str, new_text:str):
        """
    ...
    def align_annotations(self, second_annotations)->None:
        """
    ...
    def check_article_annotations_out_of_boundaries(self, article_content:str, fix_errors:bool=False):
        """
    ...
    def check_article_annotations_start_end_chars(self, article_content:str, fix_errors:bool=False):
        """
